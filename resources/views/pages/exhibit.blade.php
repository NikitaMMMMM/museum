...
@section('content')
  ...
  <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem;">
    <div>
      ...
      <div class="museum-card" style="height: 400px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; color: var(--text-muted);">
        Основное изображение
      </div>

      <div style="display: flex; gap: 1rem; margin: 2rem 0;">
        <button class="btn btn-favorite" data-id="1" id="main-favorite" style="font-size: 1.5rem;">☆</button>
        <button class="btn btn-outline" onclick="navigator.share?.({title: document.title, url: window.location.href}) || alert('Ссылка скопирована')">Поделиться</button>
      </div>
    </div>
