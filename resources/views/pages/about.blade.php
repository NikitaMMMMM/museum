...
@section('content')
  ...
  <div class="museum-card" style="padding: 3rem; text-align: center;">
    ...
    <p>Виртуальный музей создан для сохранения и демонстрации исторического наследия колледжа. Коллекция экспонаты с момента основания учебного заведения.</p>
  </div>
  ...
  <div class="museum-card" style="padding: 2rem;">
    ...
    <div style="height: 300px; background: var(--bg-secondary); display: flex; align-items: center; justify-content: center; border-radius: var(--radius);">
