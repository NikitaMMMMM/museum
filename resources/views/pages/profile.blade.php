        ...
        <div class="profile-container" style="display: grid; grid-template-columns: 300px 1fr; gap: 3rem;">
            <aside class="profile-sidebar">
                <div style="text-align: center; margin-bottom: 2rem;">
                    <div id="user-avatar"
                        style="width: 80px; height: 80px; background: var(--color-brand-blue); color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; font-weight: bold; margin: 0 auto 1rem;">
                        ИИ</div>
                    <div id="profile-name"
                        style="font-size: 1.25rem; font-weight: bold; color: var(--text-heading); margin-bottom: 0.25rem;">
                        Загрузка...</div>
            ...
            <div>
                ...
                <div id="favorites-tab" class="tab-content">
                    <h1 style="color: var(--text-heading);">Мои избранные экспонаты (<span
                            id="favorites-count-header">0</span>)</h1>
                ...
                <div id="history-tab" class="tab-content">
                    ...
                    <button class="btn btn-outline" style="margin-top: 2rem;"
                        onclick="app.viewHistory = []; localStorage.setItem('viewHistory', '[]'); app.renderHistoryList();">Очистить
                        историю</button>
                </div>
                ...
                <div id="settings-tab" class="tab-content">
                    ...
                    <button class="btn btn-outline"
                        style="background: #dc3545; color: white; border-color: #dc3545; margin-top: 2rem;">Удалить
                        аккаунт</button>
                </div>
            </div>
        </div>
